...
module "azure-express-route" {
  ...
  express_route_name = "expressRoute1"
  express_route_location = module.azure-resource-group.resource_group_location
  express_route_resource_group_name = module.azure-resource-group.resource_group_name
  express_route_service_provider_name = "Equinix"
  express_route_peering_location = "Silicon Valley"
  express_route_bandwidth_in_mbps = 50
